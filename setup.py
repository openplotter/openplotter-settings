...
setup (
	...
	entry_points={'console_scripts': ['openplotter-settings=openplotterSettings.openplotterSettings:main','openplotter-startup=openplotterSettings.startup:main','settingsPreUninstall=openplotterSettings.settingsPreUninstall:main']},
