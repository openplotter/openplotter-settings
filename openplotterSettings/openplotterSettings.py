...
class MyFrame(wx.Frame):
	def __init__(self):
		...
		'sources': ['https://dl.cloudsmith.io/public/openplotter/openplotter/deb/debian','https://repos.influxdata.com/debian','https://packages.grafana.com/oss/deb'],
		'dev': 'no',
		...
		'sources': ['https://dl.cloudsmith.io/public/openplotter/openplotter/deb/debian','https://deb.nodesource.com/node_10.x'],
		'dev': 'no',
		...
		'sources': ['https://dl.cloudsmith.io/public/openplotter/openplotter/deb/debian','http://ppa.launchpad.net/opencpn/opencpn/ubuntu'],
		'dev': 'no',
